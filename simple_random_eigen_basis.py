...
plt.ylabel('MSE, %')
plt.title('reconstructed image simple basis')

f,(ax1,ax2)=plt.subplots(1,2)
ax1.matshow(np.reshape(reconst,(y,x)), cmap='gray')
ax1.axis('off')
ax1.set_title('reconstructed image from {}% of simple basis'.format(new_ticks[-1]))
ax2.matshow(np.reshape(im,(y,x)), cmap='gray')
ax2.axis('off')
ax2.set_title('initial')
del simple_basis
...
plt.xlabel('% of initial basis')
plt.ylabel('MSE, %')
plt.title('reconstructed image random basis')


f,(ax1,ax2)=plt.subplots(1,2)
ax1.matshow(np.reshape(reconst,(y,x)), cmap='gray')
ax1.axis('off')
ax1.set_title('reconstructed image from {}% of random basis'.format(new_ticks[-1]))
ax2.matshow(np.reshape(im,(y,x)), cmap='gray')
ax2.axis('off')
ax2.set_title('initial')
...
plt.xlabel('% of initial basis')
plt.ylabel('MSE, %')
plt.title('reconstructed image eigen basis')

f,(ax1,ax2)=plt.subplots(1,2)
ax1.matshow(np.reshape(reconst,(y,x)), cmap='gray')
ax1.axis('off')
ax1.set_title('reconstructed image from {}% of eigen basis'.format(new_ticks[-1]))
ax2.matshow(np.reshape(im,(y,x)), cmap='gray')
ax2.axis('off')
ax2.set_title('initial')